...
inline unsigned PhysicalSystem::n_sites() const { return _n_sites; }

inline unsigned PhysicalSystem::n_cells() const { return _n_cells; }

inline unsigned PhysicalSystem::n_sites_in_cell() const {
  return _n_sites_in_cell;
}

inline unsigned PhysicalSystem::max_n_stars() const { return _max_n_stars; }

inline double PhysicalSystem::k_unit1() const { return _k_unit1; }

inline double PhysicalSystem::k_unit2() const { return _k_unit2; }

inline std::complex<double> PhysicalSystem::chi() const { return _chi; }

inline std::shared_ptr<PhysicalSystem>
