...
class HamiltonianCreator {
 public:
  virtual void creat_hamiltonian(
      arma::mat& H, const stars_ring_basis::LocalizedBasis& basis) const = 0;
  virtual void creat_hamiltonian(
      arma::sp_mat& H, const stars_ring_basis::LocalizedBasis& basis) const = 0;
...
class StandardCalculator {
 public:
  ...
  std::tuple<double, const arma::vec&> energies_states(
