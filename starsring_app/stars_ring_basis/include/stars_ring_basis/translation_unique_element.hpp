...
class TranslationUniqueElement
    : public stars_ring_core::SettledInPhysicalSystem {
 public:
  ...
  // Factory:
  friend std::unique_ptr<TranslationUniqueElement>
 ...
 private:
  TranslationUniqueElement(
      std::shared_ptr<stars_ring_core::PhysicalSystem> physical_system,
      const std::vector<unsigned>& state, unsigned perturbation_order);
...
inline const RawState& TranslationUniqueElement::raw_representative_state()
    const {
  return _raw_representative_state;
}

inline unsigned TranslationUniqueElement::cycle_length() const {
  return _cycle_length;
}

inline unsigned TranslationUniqueElement::perturbation_order() const {
  return _perturbation_order;
}

inline typename TranslationUniqueElement::KeyT TranslationUniqueElement::key()
    const {
  return _raw_representative_state;
}

inline unsigned TranslationUniqueElement::n_stars_A() const {
  return _n_stars_A;
}

inline unsigned TranslationUniqueElement::n_stars_B() const {
  return _n_stars_B;
}

inline unsigned TranslationUniqueElement::n_stars() const { return _n_stars; }
