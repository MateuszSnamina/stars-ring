...
namespace stars_ring_basis {
    ...
    inline
    const RawState &
    LocalizedElement::raw_state() const {
        return _raw_state;
    }

    inline
    unsigned
    LocalizedElement::perturbation_order() const {
        return _perturbation_order;
    }

    inline
    typename LocalizedElement::KeyT
    LocalizedElement::key() const {
        return _raw_state;
    }

    inline
    unsigned
    LocalizedElement::n_stars_A() const {
        return _n_stars_A;
    }

    inline unsigned
    LocalizedElement::n_stars_B() const {
        return _n_stars_B;
    }

    inline unsigned
    LocalizedElement::n_stars() const {
        return _n_stars;
    }
