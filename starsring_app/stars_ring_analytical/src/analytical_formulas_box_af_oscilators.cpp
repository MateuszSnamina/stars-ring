...
double AnalyticalFormulasBoxAfOscylators::ground_state_classical_energy()
    const {
  return 0.0;
}

double AnalyticalFormulasBoxAfOscylators::ground_state_correlation_energy()
    const {
...
double AnalyticalFormulasBoxAfOscylators::exc_state_relative_energy(
    unsigned nk) const {
